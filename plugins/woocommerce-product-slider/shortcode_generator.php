...
<html>
	<head>			
		...
		.stf {display:none;}
		#TB_ajaxContent {height:600px !important;}
		...
		<script>
			...
			function gen_shortcode() {
				...
				//check for type of products want to show
				if(typeof jQuery("input:radio[name=prod_type]:checked").val()!=='undefined') {
					shortcode+= ' show_products="'+jQuery("input:radio[name=prod_type]:checked").val()+'"';
				}
				...
				if(jQuery('#transparent').attr('checked')) {
					shortcode +=' transparent="true"';
				} else {
					shortcode +=' transparent="false"';
				}
//.flexslider ul.slides li .psc-prod-container {  -- merchant-theme
				if(jQuery('#bgcolor').val()!='') {	
						shortcode +=' background_color="'+jQuery('#bgcolor').val()+'"';
				}
				if(jQuery('#titlecolor').val()!='') {	
						shortcode +=' title_color="'+jQuery('#titlecolor').val()+'"';
				}
				
				if(jQuery('#pricecolor').val()!='') {	
						shortcode +=' price_color="'+jQuery('#pricecolor').val()+'"';
				}
				
				if(jQuery('#bordercolor').val()!='') {	
						shortcode +=' border_color="'+jQuery('#bordercolor').val()+'"';
				}
	...
	<body>
		<table cellspacing="5" cellpadding="5">
				...
				<tr>
					<td align="left">Transperant</td>
					<td>
						<span class="on_off">
							<input type="checkbox" value="true" name="transparent" id="transparent">
						</span>
					</td>
				</tr>
				<tr>
					...
					<td>				
						<input type="text" value="" class="zdev-wcps-color-picker" name="bgcolor" id="bgcolor" />
					<script>
						jQuery('.zdev-wcps-color-picker').wpColorPicker();  
					</script>
					</td>
				</tr>
			
				<tr>
					<td align="left">Title Font Color</td>
					<td>				
						<input type="text" value="" class="zdev-wcps-color-picker" name="titlecolor" id="titlecolor" />
				<script>
						jQuery('.zdev-wcps-color-picker').wpColorPicker();  
					</script>
					</td>
				...
				<tr>
					<td align="left">Price Font Color</td>
					<td>				
						<input type="text" value="" class="zdev-wcps-color-picker" name="pricecolor" id="pricecolor" />
				<script>
						jQuery('.zdev-wcps-color-picker').wpColorPicker();  
					</script>
					</td>
					...
					<td>				
						<input type="text" value="" class="zdev-wcps-color-picker" name="bordercolor" id="bordercolor" />
				<script>
						jQuery('.zdev-wcps-color-picker').wpColorPicker();  
					</script>
					</td>
				...
				<tr>
					<td align="left" colspan="2"><strong>Padding</strong> Top&nbsp;<input type="text" value="" name="padding_top" id="padding_top" size="2"/>px&nbsp;&nbsp;Left&nbsp;<input type="text" value="" name="padding_left" id="padding_left" size="2"/>px&nbsp;&nbsp;Right&nbsp;<input type="text" value="" name="padding_right" id="padding_right"  size="2"/>px&nbsp;&nbsp;Bottom&nbsp;<input type="text" value="" name="padding_bottom" id="padding_bottom"  size="2"/>px						

					</td>
				</tr>
				<tr>
					<td style="border-top: 1px solid #CCC;border-bottom: 1px solid #CCC;">&nbsp;</td>
						<td align="left" style="border-top: 1px solid #CCC;border-bottom: 1px solid #CCC;"><input type='radio' name='prod_type' value='new'/>Show New Products<br/><input type='radio' name='prod_type' value='featured'/>Show Featured Products<br/><input type='radio' name='prod_type' value='sale'/>Show OnSale Products</td>
				</tr>
				<tr>
