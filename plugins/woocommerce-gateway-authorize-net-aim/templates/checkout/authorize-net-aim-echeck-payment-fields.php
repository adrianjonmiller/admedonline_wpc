...
<div class="sample-check" style="display:none;">
	<p><?php _e( 'How to find your ABA routing number and account number', WC_Authorize_Net_AIM::TEXT_DOMAIN ); ?></p>
...
<fieldset>
	<div class="wc-authorize-net-aim-echeck-new-payment-method-form js-wc-authorize-net-aim-echeck-new-payment-method-form">
		...
		<p class="form-row form-row-first">
			<label for="wc-authorize-net-aim-echeck-routing-number"><?php _e( 'Routing Number (9 digits)', WC_Authorize_Net_AIM::TEXT_DOMAIN ); ?> <img title="<?php esc_attr_e( 'Where do I find this?', WC_Authorize_Net_AIM::TEXT_DOMAIN ); ?>" class="js-wc-authorize-net-aim-echeck-account-help" style="margin-bottom:3px;cursor:pointer;box-shadow:none;" src="<?php echo WC()->plugin_url(); ?>/assets/images/help.png" width="16" height="16" /></label>
		...
		<p class="form-row">
			<label for="wc-authorize-net-aim-echeck-account-type"><?php _e( 'Account Type', WC_Authorize_Net_AIM::TEXT_DOMAIN ); ?> <span class="required">*</span></label>
			<select id="wc-authorize-net-aim-echeck-account-type" name="wc-authorize-net-aim-echeck-account-type" class=" js-wc-payment-gateway-account-type" style="width:auto;">
				<option value="checking"><?php _e( 'Checking', WC_Authorize_Net_AIM::TEXT_DOMAIN ); ?></option>
				<option value="savings"><?php _e( 'Savings', WC_Authorize_Net_AIM::TEXT_DOMAIN ); ?></option>
			</select>
		</p>
		<div class="clear"></div>
