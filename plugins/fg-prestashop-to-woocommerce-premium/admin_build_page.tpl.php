...
<div class="wrap" style="float: left;">
	...
	<form action="" method="post">
		...
		<table class="form-table">
			...
			<tr>
				<th scope="row"><label for="prefix"><?php _e('Cookie key', 'fgp2wcp'); ?></label></th>
				<td><input id="cookie_key" name="cookie_key" type="text" size="60" value="<?php echo $data['cookie_key']; ?>" /><br />
					<small><?php _e('The cookie key is used to authenticate the customers on WordPress with their PrestaShop password.', 'fgp2wcp'); ?></small>
				</td>
			</tr>
			<tr>
				<th scope="row">&nbsp;</th>
			...
			<tr>
				...
				<td>
					<input id="import_meta_seo" name="import_meta_seo" type="checkbox" value="1" <?php checked($data['import_meta_seo'], 1); ?> /> <label for="import_meta_seo" ><?php _e('Import the meta data to WordPress SEO by Yoast', 'fgp2wcp'); ?></label>
					<br />
...
<script type="text/javascript">
	...
	jQuery( "#partial_import" ).hide();
	jQuery( "#partial_import_toggle" ).click(function() {
		jQuery( "#partial_import" ).slideToggle( "slow" );
	});
</script>
