...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            wp_register_script('flexslider', get_template_directory_uri() . '/bower_components/flexslider/jquery.flexslider-min.js', array(), '0.0.0');
...
function html5blank_styles()
{
    if (HTML5_DEBUG) {
        ...
        wp_register_style('ionicons', get_template_directory_uri() . '/bower_components/ionicons/css/ionicons.min.css', array(), '1.0');
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Footer Widget Area', 'html5blank'),
        'id' => 'widget-area-3',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
    ...
    register_sidebar(array(
        'name' => __('Header', 'html5blank'),
        'description' => __('Header Widget Area', 'html5blank'),
        'id' => 'widget-area-4',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
    ...
    register_sidebar(array(
        'name' => __('Front Page', 'html5blank'),
        'description' => __('Front Page Widget Area', 'html5blank'),
        'id' => 'front-page',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3 class="heading-medium" align="center">',
        'after_title' => '</h3>'
    ));
}
...
function create_post_type_html5()
{
    ...
    register_post_type('banner', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Banner Image', 'html5blank'), // Rename these to suit
            'singular_name' => __('Banner Image', 'html5blank'),
            'add_new' => __('Add New', 'html5blank'),
            'add_new_item' => __('Add New HTML5 Blank Custom Post', 'html5blank'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Banner', 'html5blank'),
            'new_item' => __('New Banner', 'html5blank'),
            'view' => __('View Banner', 'html5blank'),
            'view_item' => __('View Banner', 'html5blank'),
            'search_items' => __('Search Banners', 'html5blank'),
            'not_found' => __('No Banners', 'html5blank'),
            'not_found_in_trash' => __('No Banners found in Trash', 'html5blank')
        ),
        'public' => true,
